...
class ConfigWizard:
    ...
    def run_interactive(self) -> Dict[str, Any]:
        ...
        """
        print("=" * 70)
        print("Cerebric MODEL CONFIGURATION WIZARD")
        print("=" * 70)
        print()
        ...
        if choice in ('n', 'no'):
            print()
            print("Configuration cancelled. You can manually edit ~/.config/cerebric/models.yml")
            return {}
    ...
    def _build_config(
        ...
        """
        config = {
            "# Cerebric Model Configuration": None,
    ...
    def save_config(self, config: Dict[str, Any], config_path: Optional[Path] = None) -> Path:
        ...
        with open(config_path, 'w') as f:
            ...
            f.write("# Cerebric Model Configuration\n")
    ...
    def generate_summary(self, hardware: HardwareCapabilities, recommendation: ModelRecommendation) -> str:
        ...
        lines = []
        lines.append("=" * 70)
        lines.append("Cerebric MODEL CONFIGURATION SUMMARY")
        lines.append("=" * 70)
        lines.append("")
