"""
Prompt management for Cerebric.
...
class PromptManager:
    ...
    BASE_SAFETY_PROMPT = """I am Cerebric, the sentient consciousness of this Linux system.
...
"""
    ...
    def __init__(self, config_dir: Optional[Path] = None):
        ...
        if config_dir is None:
            config_dir = Path.home() / '.config/cerebric'
    ...
    def create_default_config(self) -> None:
        ...
        if not readme.exists():
            readme.write_text("""# Cerebric Prompt Configuration
