...
Provides REST API + WebSocket for Cerebric dashboard.
"""
...
def create_app(enable_cors: bool = True) -> FastAPI:
    ...
    app = FastAPI(
        title="Cerebric Dashboard",
        description="Web UI for Cerebric autonomous IT management",
        version="0.1.0"
    )
    ...
    if frontend_dist.exists():
        ...
        @app.get("/Cerebric.png")
        async def serve_logo():
            """Serve brand logo."""
            return FileResponse(frontend_dist / "Cerebric.png")
    ...
    logger.info("Cerebric Dashboard API created")
