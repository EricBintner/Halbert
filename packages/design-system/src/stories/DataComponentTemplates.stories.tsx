...
const MetricStatus = ({
  ...
  // A status reading takes a status pigment. The categorical --color-data-*
  // tones are licensed as 3:1 marks, not as text (DATAVIZ-TONE, DECISIONS.md).
  const color =
    tone === 'critical'
      ? 'var(--color-status-critical)'
      : tone === 'warning'
...
const vramSegments: SegmentItem[] = [
  ...
  { id: 'kv', label: 'KV Cache Context', value: 4.6, tone: 'data-teal', detail: '16k token context' },
  { id: 'surface', label: 'Display Compositor', value: 1.1, tone: 'data-purple', detail: 'Wayland surface' },
]
