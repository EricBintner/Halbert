...
Wraps existing cerebric_core journald ingestion functionality
...
if cerebric_path not in sys.path:
    sys.path.insert(0, cerebric_path)

from cerebric_core.ingestion.journald import follow_journal
...
class JournaldAdapter:
    ...
    Wraps existing cerebric_core.ingestion.journald functionality.
    """
    ...
    def collect_logs(
        ...
        if follow:
            ...
            import subprocess
            import json
            from cerebric_core.ingestion.journald import _normalize
