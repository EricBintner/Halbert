...
Wraps existing cerebric_core hwmon sensor functionality
...
from cerebric_core.ingestion.hwmon import collect_temp
...
class HwmonAdapter:
    ...
    Wraps existing cerebric_core.ingestion.hwmon functionality.
    """
