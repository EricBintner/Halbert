...
/**
 * Cold start: what the conversation toggle says before it knows the machine's name.
 *
 ...
 * label never flashes when you toggle panels — which means "has never resolved"
...
describe('PanelToggle cold start', () => {
  it('falls back to the app name before identity resolves', () => {
    // A fetch that never settles: the button still has to say something.
