/**
 * ChatPanel - Side panel chat for Halbert Dashboard.
 * 
...
export function ChatPanel() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('halbert:open-chat', handleOpenChat as EventListener)
    return () => {
      window.removeEventListener('halbert:open-chat', handleOpenChat as EventListener)
    }
  }, [])
