...
if FASTAPI_AVAILABLE:
    ...
    async def send_message(request: ChatRequest, response: Request):
        """
        Send a chat message and get AI response.

        [DEPRECATED] Use POST /api/agent/message instead.
        This endpoint will be removed in a future release.
        """
        # Phase 4: Deprecation header
        response.headers["Deprecation"] = "true"
        response.headers["Link"] = '</api/agent/message>; rel="successor-version"'
        import time
    ...
    async def send_message_stream(request: ChatRequest):
        ...
        return StreamingResponse(
            ...
            headers={
                ...
                "Deprecation": "true",
                "Link": '</api/agent/message>; rel="successor-version"',
            }
        )
...
if FASTAPI_AVAILABLE:
    ...
    async def config_chat(request: ConfigChatRequest, response: Request):
        """
        Chat endpoint for config file editing.

        [DEPRECATED] Use POST /api/agent/message with write_config tool instead.
