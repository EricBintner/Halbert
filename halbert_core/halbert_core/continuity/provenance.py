...
ERASURE_LIMITS = (
    ...
    "which are redacted separately; sensor and machine-state rows in the "
    "event ledger (timeline.db) other than the occupancy and state rows for "
    "a named subject, which TimelineStore.forget_subject removes; "
