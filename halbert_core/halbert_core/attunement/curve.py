...
def halbert_curve() -> Any:
    ...
    def rung(level, name, says, why, channel, patience, budget, target, ceiling, closes):
        return PresenceRung(
    ...
    return PresenceCurve(owner="halbert", rungs=(
        ...
        rung(1, "warn",
             ...
             "Warnings are worth your attention. Nothing else is pushed.",
             l1, 240.0, 2, M, M, None),   # target == ceiling: "talk to me more" must not widen a quiet level (Q7.6)
        rung(3, "morning",
             "I'll give you the morning, and tell you what keeps happening.",
        ...
        rung(6, "recall",
             ...
             l6, 120.0, 5, N, CH, 5),
        rung(8, "associate",
             "I'll say what your work reminds me of.",
