...
def test_hardware_profiles():
    ...
    try:
        from cerebric_core.cerebric_core.model import HardwareDetector, HardwareProfile
...
def test_mac_detection():
    ...
    try:
        from cerebric_core.cerebric_core.utils.platform import (
...
def test_config_wizard_auto():
    ...
    try:
        from cerebric_core.cerebric_core.model import ConfigWizard
